...
import com.ssafy.vue.model.dto.HouseInfoDto;
import com.ssafy.vue.model.dto.SidoGugunCodeDto;
...
public class HouseMapController {
	...
	public ResponseEntity<String> aptList(@PathVariable("lawd_cd") String lawdCd, @PathVariable("deal_ymd") String dealYmd) throws IOException {
		...
		String serviceKey = "OXa%2FVCW9vmpAhOmDqGRzOVaOXclayry8A2aPe8DPxO4TiOK2h9CoRLnTSqo78he4NKVCtj4PR0qE9nQqFUyhdA%3D%3D";
	...
	@ApiOperation(value = "아파트 목록", notes = "동코드를 기준으로 아파트 목록을 반환한다.", response = List.class)
	@GetMapping("/apt")
	public ResponseEntity<List<HouseInfoDto>> apt(@RequestParam("dong") String dong) throws Exception {
		logger.info("dongSearch - 호출");
